...
public class UserRepoImp implements UserRepository {
    ...
    @Override
    public int create(String firstName, String lastName, String email, String password) throws EtAuthException {
    ...
    public int getCountByEmail(String email) {
        return jdbcTemplate.queryForObject(SQL_COUNT_BY_EMAIL, new Object[]{email}, int.class);
    }
